...
public class McardGrZahtjevTabFinalizacijaDodatni extends AS2View2 implements McardGrZahtjevConstants {
	
	public static McardGrZahtjevTabFinalizacijaDodatni view;
	...
	public McardGrZahtjevTabFinalizacijaDodatni(McardGrZahtjevDodatniMWindow parent,Record record) {
		_record = record;
		_parent = parent;
	...
	public void customWindowPreferences() {
		number_of_columns = 2;
		McardGrZahtjevTabFinalizacijaDodatni.view=this;
	}
...
//        broj_partije_mcard.getField().setAlign(Alignment.LEFT);
        ...
        form.setFields(broj_zahtjeva,section_odluka,status_odobrenja,
        		osoba_odobravanja,datum_odobravanja,komentar,
