...
//
//
////		FusionChart chart1 = new FusionChart("FCF_StackedColumn2D.swf", "400",
////				"350", "StCol2D.xml");
////		FusionChart chart2 = new FusionChart("FCF_StackedBar2D.swf", "400",
////				"350", "StBar2D.xml");
////		FusionChart chart3 = new FusionChart("FCF_Doughnut2D.swf", "400",
////				"350", "Doughnut2D.xml");
////		FusionChart chart4 = new FusionChart("FCF_Funnel.swf", "350", "300",
////				"Funnel.xml");
////		HorizontalPanel northLayout = new HorizontalPanel();
////		northLayout.setHeight("50%");
//////		com.google.gwt.dom.client.Style style = northLayout.getsty();
//////		style.setBackgroundColor("#FFFFFF");
//////		northLayout.setsty
////		northLayout.getElement().getStyle().setBackgroundColor("#FFFFFF");
//////		northLayout.setBackgroundColor("#FFFFFF");
////		northLayout.add(chart1);
////		northLayout.add(chart2);
////		HorizontalPanel southLayout = new HorizontalPanel();
////		southLayout.setHeight("50%");
////		southLayout.getElement().getStyle().setBackgroundColor("#FFFFFF");
////		southLayout.add(chart3);
////		southLayout.add(chart4);
////		main.add(northLayout);
////		main.add(southLayout);
////		chart = createChart();
////		main.setMargin(0);
////		main.addMember(createChart());
////		main.addMember(createChart1());
