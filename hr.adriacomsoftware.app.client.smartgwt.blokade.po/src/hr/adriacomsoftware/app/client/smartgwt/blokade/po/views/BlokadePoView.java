 ...
 *
 */ 
public class BlokadePoView extends AS2View2 implements BlokadePoConstants {
...
//	protected UpisnicaMWindow upisnica_modal;
	...
	public BlokadePoView(String name) {
		super(name);
	}
	...
	public void windowLayout() {
		...
		this.addMembers(_searchForm,_toolStrip,_listGrid,_listGrid.getStatusBar());
	}
//	
//	@Override
...
//		toolStrip.addButton(sixth);
		...
		eight.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event){
				TraziFormWindow trazi = new TraziFormWindow(BlokadePoView.this,_listGrid,true,false);
				trazi.setHeight(300);
			}
		});
